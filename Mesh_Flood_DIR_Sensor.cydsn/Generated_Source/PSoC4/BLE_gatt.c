    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'M', (uint8)'M', (uint8)'M', (uint8)'M', (uint8)'M',

    /* Appearance */
    0x00u, 0x00u,

    /* Peripheral Preferred Connection Parameters */
    0x10u, 0x00u, 0x14u, 0x00u, 0x00u, 0x00u, 0xC8u, 0x00u,
    ...
    /* CUD */
    (uint8)'A', (uint8)'d', (uint8)'d', (uint8)'r', (uint8)' ', (uint8)'T', (uint8)'y', (uint8)'p', (uint8)'e',
    (uint8)':', (uint8)'A', (uint8)'d', (uint8)'d', (uint8)'r', (uint8)'e', (uint8)'s', (uint8)'s', (uint8)':',
    (uint8)'R', (uint8)'G', (uint8)'B', (uint8)' ', (uint8)'D', (uint8)'a', (uint8)'t', (uint8)'a',

    /* Data Count */
    0x00u,

    /* CUD */
    (uint8)'D', (uint8)'a', (uint8)'t', (uint8)'a', (uint8)' ', (uint8)'C', (uint8)'o', (uint8)'u', (uint8)'n',
    (uint8)'t',
    ...
    /* CUD */
    (uint8)'N', (uint8)'o', (uint8)'d', (uint8)'e', (uint8)' ', (uint8)'A', (uint8)'d', (uint8)'d', (uint8)'r',
    (uint8)'e', (uint8)'s', (uint8)'s',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* RGB */
    { 0x31u, 0x01u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xBBu, 0xC2u, 0x03u, 0x00u },
    /* LED Control */
    { 0x31u, 0x01u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xB1u, 0xC2u, 0x03u, 0x00u },
    /* Data Count */
    { 0x10u, 0x13u, 0xB0u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x00u, 0x01u, 0x00u, 0xB2u, 0xC2u, 0x03u, 0x00u },
    /* Node */
    { 0x31u, 0x01u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xB0u, 0xCCu, 0x03u, 0x00u },
    /* Address */
    { 0x31u, 0x01u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xB1u, 0xCCu, 0x03u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* RGB UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* LED Control UUID */
    { 0x0008u, (void *)&cyBle_attValues[19] }, /* LED Control */
    { 0x001Au, (void *)&cyBle_attValues[27] }, /* CUD */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* Data Count UUID */
    { 0x0001u, (void *)&cyBle_attValues[53] }, /* Data Count */
    { 0x000Au, (void *)&cyBle_attValues[54] }, /* CUD */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* Node UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[4] }, /* Address UUID */
    { 0x0002u, (void *)&cyBle_attValues[64] }, /* Address */
    { 0x000Cu, (void *)&cyBle_attValues[66] }, /* CUD */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x16u] = {
    ...
    { 0x000Eu, 0xC2B1u /* LED Control                         */, 0x090A0101u /* rd,wr  */, 0x000Fu, {{0x0008u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2901u /* CUD                                 */, 0x01020001u /* rd     */, 0x000Fu, {{0x001Au, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2803u /* Characteristic                      */, 0x00060001u /* rd,wwr */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0011u, 0xC2B2u /* Data Count                          */, 0x09060101u /* rd,wwr */, 0x0012u, {{0x0001u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0012u, 0x2901u /* CUD                                 */, 0x01020001u /* rd     */, 0x0012u, {{0x000Au, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0013u, 0x2800u /* Primary service                     */, 0x08000001u /*        */, 0x0016u, {{0x0010u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr  */, 0x0016u, {{0x0010u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0015u, 0xCCB1u /* Address                             */, 0x090A0101u /* rd,wr  */, 0x0016u, {{0x0002u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0016u, 0x2901u /* CUD                                 */, 0x01020001u /* rd     */, 0x0016u, {{0x000Cu, (void *)&cyBle_attValuesLen[15]}} },
};

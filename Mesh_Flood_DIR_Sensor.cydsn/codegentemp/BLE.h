...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_TIMEOUT                  (0x7FFFu)
    ...
    #define CYBLE_FAST_SCAN_WINDOW                  (0x0020u)
    #define CYBLE_FAST_SCAN_TIMEOUT                 (0x0006u)
    ...
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MIN      (0x0007u)
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MAX      (0x0009u)
    #define CYBLE_GAPC_CONNECTION_SLAVE_LATENCY     (0x0000u)
    #define CYBLE_GAPC_CONNECTION_TIME_OUT          (0x0258u)
...
#define CYBLE_SCN_PKT_INDEX_SERVICE_DATA_RGB   (0x00u)

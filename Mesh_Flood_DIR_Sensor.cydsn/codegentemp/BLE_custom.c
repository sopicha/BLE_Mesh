...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* RGB service */
    {
        0x000Cu, /* Handle of the RGB service */ 
        {
            ...
            /* Data Count characteristic */
            {
                ...
                /* Array of Descriptors handles */
                {
                    0x0012u, /* Handle of the CUD descriptor */ 
                }, 
            },
        }, 
    },
    ...
    /* Node service */
    {
        0x0013u, /* Handle of the Node service */ 
        {

            /* Address characteristic */
            {
                0x0015u, /* Handle of the Address characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0016u, /* Handle of the CUD descriptor */ 
                }, 
            },
            {
...
static const CYBLE_UUID128_T cyBle_customUuid128[] = {
    /* RGB */
    { {0x10u, 0x13u, 0xB0u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x00u, 0x01u, 0x00u, 0xBBu, 0xC2u, 0x03u, 0x00u} },
    /* LED Control */
...
static CYBLE_CUSTOMC_DESC_T cyBle_customCDesc[0x03u] = {
...
static CYBLE_CUSTOMC_CHAR_T cyBle_customCChar[0x03u] = {
    ...
    /* Data Count */
    {
        ...
        0x00u, /* Characteristic properties */ 
        0x01u, /* Number of descriptors */ 
        &cyBle_customCDesc[1], /* Characteristic Descriptors */ 
    },
    ...
    /* Address */
    {
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Characteristic handle */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Characteristic end handle */ 
        (const CYBLE_UUID128_T *) &cyBle_customUuid128[4], /* 128-bit UUID */ 
        0x02u, /* UUID Format - 16-bit (0x01) or 128-bit (0x02) */ 
        0x00u, /* Characteristic properties */ 
        0x01u, /* Number of descriptors */ 
        &cyBle_customCDesc[2], /* Characteristic Descriptors */ 
    },
};
...
CYBLE_CUSTOMC_T cyBle_customCServ[CYBLE_CUSTOMC_SERVICE_COUNT] = {
    ...
    /* RGB */
    {
        ...
        0x02u, /* UUID Format - 16-bit (0x01) or 128-bit (0x02) */ 
        0x02u, /* Number of characteristics */ 
    ...
    {
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Custom Service handle */ 
        (const CYBLE_UUID128_T *) &cyBle_customUuid128[3], /* 128-bit UUID */ 
        0x02u, /* UUID Format - 16-bit (0x01) or 128-bit (0x02) */ 
        0x01u, /* Number of characteristics */ 
        &cyBle_customCChar[2], /* Custom Service Characteristics */ 
    },
};
